...
data class CafeCartItemDTO(
    ...
    companion object {
        fun fromModel(cafeCartItem: CafeCartItem): com.breadkun.backend.cafe.cart.dto.response.CafeCartItemDTO {
            return com.breadkun.backend.cafe.cart.dto.response.CafeCartItemDTO(
                id = cafeCartItem.id,
