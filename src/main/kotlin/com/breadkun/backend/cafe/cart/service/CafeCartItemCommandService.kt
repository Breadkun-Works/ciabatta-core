...
class CafeCartItemCommandServiceImpl(
    ...
    private val cafeCartQueryService: com.breadkun.backend.cafe.cart.service.CafeCartQueryService,
    private val cafeMenuQueryService: CafeMenuQueryService
) : com.breadkun.backend.cafe.cart.service.CafeCartItemCommandService {
    @Transactional
