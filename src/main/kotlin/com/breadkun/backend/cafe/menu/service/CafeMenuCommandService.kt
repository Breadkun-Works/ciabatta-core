...
interface CafeMenuCommandService {
    ...
    suspend fun updateCafeMenu(cafeMenuId: String, userID: String, dto: com.breadkun.backend.cafe.menu.dto.request.CafeMenuUpdateDTO): com.breadkun.backend.cafe.menu.dto.response.CafeMenuDTO?
...
class CafeMenuCommandServiceImpl(
    ...
    private val cafeMenuQueryService: com.breadkun.backend.cafe.menu.service.CafeMenuQueryService
) : com.breadkun.backend.cafe.menu.service.CafeMenuCommandService {
    ...
    override suspend fun updateCafeMenu(cafeMenuId: String, userID: String, dto: com.breadkun.backend.cafe.menu.dto.request.CafeMenuUpdateDTO): com.breadkun.backend.cafe.menu.dto.response.CafeMenuDTO? {
