...
interface CafeMenuQueryService {
    suspend fun findCafeMenuById(cafeMenuId: String): com.breadkun.backend.cafe.menu.dto.response.CafeMenuDTO?
...
class CafeMenuQueryServiceImpl(
    ...
    override suspend fun findCafeMenuById(cafeMenuId: String): com.breadkun.backend.cafe.menu.dto.response.CafeMenuDTO? {
