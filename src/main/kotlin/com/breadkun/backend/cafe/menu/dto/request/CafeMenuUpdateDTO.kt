package com.breadkun.backend.cafe.menu.dto.request
...
data class CafeMenuUpdateDTO(
    ...
    fun toModel(cafeMenuId: String, userID: String, existingMenu: com.breadkun.backend.cafe.menu.dto.response.CafeMenuDTO): com.breadkun.backend.cafe.menu.model.CafeMenu {
        return com.breadkun.backend.cafe.menu.model.CafeMenu(
            id = cafeMenuId,
