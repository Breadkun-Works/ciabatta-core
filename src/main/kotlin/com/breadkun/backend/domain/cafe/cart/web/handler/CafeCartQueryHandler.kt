package com.breadkun.backend.domain.cafe.cart.web.handler

import com.breadkun.backend.domain.cafe.cart.service.CafeCartQueryService
...
class CafeCartQueryHandler(
    ...
    suspend fun findActiveCafeCartsByOptions(request: ServerRequest): ServerResponse {
        ...
        val result = cafeCartQueryService.findActiveCafeCartsByOptions(createdById)
